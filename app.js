function markAttendance() {
    ...
    if (hours < 10 || (hours === 10 && minutes <= 5)) {
        attendanceStatus.textContent = "Good morning, " + employeeName + "! You're on time.";
    } else {
        attendanceStatus.textContent = "Warning, " + employeeName + "! You're late.";
        // Deduct salary or take other actions for being late
    }

    var historyItem = document.createElement("li");
    historyItem.textContent = employeeName + ": " + (hours < 10 ? "On time" : "Late");
